const ReporterType = require('./reporter.enum'),
  StyleLintReporter = require('./reporters/stylelint.reporter'),
...
class ReporterFactory {
  ...
  static create (type, options, projectName) {
    ...
    switch (type) {
      ...
      case ReporterType.STYLELINT:
        opts = ReporterFactory.mergeOptions(options, StyleLintReporter.defaultOptions());
        reporter = new StyleLintReporter(opts, projectName);
        break;
